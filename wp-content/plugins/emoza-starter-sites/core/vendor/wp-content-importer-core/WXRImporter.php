...
class EMWC_WXRImporter extends WP_Importer {
	/**
	...
	public function __construct( $options = array() ) {
		...
		$this->options = wp_parse_args( $options, array(
			'disable_cache'                    => apply_filters( 'emwc_disable_demo_content_cache', false ),
	...
	protected function process_attachment( $post, $meta, $remote_url ) {
		...
		// [EMWC] Placeholder attachment action.
		do_action( 'emwc_importer.processed.attachment', $upload );
